...
- (void)setShouldOrderResults:(BOOL)shouldOrderResults {
  [[NSUserDefaults standardUserDefaults] setBool:shouldOrderResults forKey:@"ShouldOrderResults"];
  [[NSUserDefaults standardUserDefaults] synchronize];
}
- (BOOL)shouldOrderResults {
  return [[NSUserDefaults standardUserDefaults] boolForKey:@"ShouldOrderResults"];
}
